...
(() => {
    ...
    class DesktopWindow {
        ...
        setTitle(title) { title = OS.lunaWindowTitle?.(this.appId,title) || title; this.title = title; this.titleEl.lastElementChild.textContent = title; this.el.setAttribute('aria-label', title); OS.emit('windows'); }
