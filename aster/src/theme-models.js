...
(function(root, factory) {
    ...
    const PRESETS = [
        preset('luna-korpus','Luna Korpus',{"shellMode":"dark","appMode":"light","accent":"#0078c8","selection":"#0078c8","accentOnTitle":true,"transparency":true,"background":{"type":"color","color":"#0b3a5b"},"colors":{"ActiveTitle":"#0078c8","TitleText":"#ffffff"},"titleHeight":36,"taskbar":{"position":"bottom","align":"center","size":40},"iconFamily":"windows"}),
    ...
    const getPreset = id => structuredClone(PRESETS.find(t => t.id === id) || PRESETS.find(t => t.id === 'windows-light'));
