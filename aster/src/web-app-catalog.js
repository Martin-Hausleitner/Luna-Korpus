...
(() => {
  ...
  "updatedAt": "2026-09-12T11:58:34.208018+00:00"
    ...
    for (const app of data.apps) {
        ...
        app.title = ({"Gridline": "Tabelle (Gridline)", "MeridianPlan": "Planung (MeridianPlan)", "MeridianOffice": "Office (MeridianOffice)", "TwinForge": "Dateien (TwinForge)", "Folio": "Akte (Folio)", "FolioPro": "PDF (FolioPro)", "Quire": "Mail (Quire)", "NotepadXP": "Text (NotepadXP)", "LatticeAnalytics": "Auswertung (LatticeAnalytics)", "AxiomWorksheet": "Rechenblatt (AxiomWorksheet)", "Draftline": "Zeichnung (Draftline)", "KestrelCAD": "CAD (KestrelCAD)", "PlanforgeReview": "Aufmaß (PlanforgeReview)", "Orivane": "Tafel (Orivane)", "VeyraWorkspace": "Gespräch (Veyra Workspace)", "Velsign": "Signatur (Velsign)", "Formalyth": "Korpus (Formalyth)", "StrataForge": "Material (StrataForge)", "AvolithStudio": "Modell (Avolith Studio)"})[app.repo] || app.title + ' (' + app.repo + ')';
